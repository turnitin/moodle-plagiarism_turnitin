...
$string['ppagreement_default'] = 'Jag bekräftar att detta inlämnande är mitt eget arbete och jag accepterar allt ansvar för eventuella intrång i upphovsrätten som kan uppstå som en följd av detta inlämnande.';
$string['ppagreement_desc'] = '<b>[Valfritt]</b><br />Ange en avtalsbekräftelse för inlämningar. <br />(<b>Obs:</b> Om avtalsdelen lämnas helt tom kommer ingen avtalsbekräftelse att krävas av studenterna under deras inlämnande.';
$string['ppagreement'] = 'Friskrivningsklausul/avtal';
