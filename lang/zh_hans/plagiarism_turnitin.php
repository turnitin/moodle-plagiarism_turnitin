...
$string['reportgenspeed_help'] = "此作业设置有三个选项：“立即生成报告。提交项将立即添加到存储库中（如果设置了存储库）。 ”、“立即生成报告。提交项将在截止日期添加到存储库中（如果设置了存储库）。”以及“ 在截止日期生成报告。提交项将在截止日期添加到存储库中（如果设置了存储库）。”<br /><br />选项“立即生成报告。提交项将立即添加到存储库中（如果设置了存储库）。”在学生提交时会立即生成原创性报告，如果提交项存储在存储库中，则会将后续提交项将与之前的提交项进行比较。<br /><br />选项“立即生成报告。提交项将在截止日期添加到存储库中（如果设置了存储库）。”在学生提交时会立即生成原创性报告，如果提交项存储在存储库中，则会在作业截止日期进行相互抄袭检查。<br /><br />选项“在截止日期生成报告。提交项将在截止日期添加到存储库中（如果设置了存储库）。”会在作业的截止日期生成原创性报告，如果提交项存储在存储库中，则执行相互抄袭检查。";
$string['turnitinuseanon_desc'] = '选择在为提交内容评分时是否允许匿名标记。<br /><i>（仅适用于已为其帐户配置了匿名标记的用户）</i>';
$string['nonsubmittingstudentinfo'] = "如需查看本次小组提交的 Turnitin 报告或反馈，请联系教师，或代小组提交作业的学生。";

$string['enableadhocsubmissions'] = "为提交队列启用临时任务处理功能";
$string['adhoc_sendqueuedsubmission'] = "临时任务：从 Turnitin 抄袭检测插件 (Plagiarism Plugin) 发送队列中的提交文件";
