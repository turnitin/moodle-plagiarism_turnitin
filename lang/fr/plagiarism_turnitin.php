...
$string['reportgenspeed_help'] = "Les paramètres de cet exercices proposent trois options : « Générer des rapports immédiatement. Les copies seront immédiatement ajoutées dans la base de données (si la base de données est définie) ». « Générer des rapports immédiatement. Les copies seront ajoutées dans la base de données à la date d'échéance (si la base de données est définie) ». Et « Générer des rapports à la date d'échéance. Les copies seront ajoutées dans la base de données à la date d'échéance (si la base de données est définie). »<br /><br />L'option « Générer des rapports immédiatement. Les copies seront immédiatement ajoutées dans la base de données (si la base de données est définie). » génère le rapport d'originalité dès qu'un étudiant envoie une copie et les copies envoyées ultérieurement seront comparées aux copies précédentes si ces dernières ont été stockées dans une base de données.<br /><br /> Générer des rapports immédiatement. Les copies seront ajoutées dans la base de données à la date d'échéance (si la base de données est définie). » génère un rapport d'originalité dès qu'un étudiant envoie une copie et une vérification de la similitude sera effectuée à la date d'échéance de l'exercice si les copies ont été stockées dans une base de données. <br /><br />L'option « Générer des rapports à la date d'échéance. Les copies seront ajoutées dans la base de données à la date d'échéance (si la base de données est définie). » génère le rapport d'originalité et effectue une vérification de la similitude à la date d'échéance de l'exercice si les copies ont été stockées dans une base de données.";
...
$string['nonsubmittingstudentinfo'] = "Afin de pouvoir accéder au rapport Turnitin ou aux commentaires relatifs à cet exercice de groupe, veuillez vous rapprocher de votre enseignant ou de l’étudiant ayant procédé à la remise du travail pour le compte de votre groupe.";

$string['enableadhocsubmissions'] = "Activer le traitement des tâches ponctuelles pour la file de traitement des copies";
$string['adhoc_sendqueuedsubmission'] = "Tâche ponctuelle : envoyer une copie en file d’attente depuis le plugin de détection du plagiat Turnitin";
