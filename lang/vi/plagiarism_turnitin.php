...
$string['erater'] = 'Bật tùy chọn phản hồi về ngữ pháp';
...
$string["reportgen_immediate_add_immediate"] = "Tạo báo cáo ngay lập tức. Báo cáo sẽ được thêm vào kho lưu trữ ngay lập tức (nếu kho lưu trữ được thiết lập).";
$string["reportgen_immediate_add_duedate"] = "Tạo báo cáo ngay lập tức. Báo cáo sẽ được thêm vào kho lưu trữ vào ngày đến hạn (nếu kho lưu trữ được thiết lập).";
$string["reportgen_duedate_add_duedate"] = "Tạo báo cáo vào ngày đến hạn. Báo cáo sẽ được thêm vào kho lưu trữ vào ngày đến hạn (nếu kho lưu trữ được thiết lập).";
...
$string['turnitinuseerater'] = 'Bật tùy chọn phản hồi về ngữ pháp';
$string['turnitinuseerater_desc'] = 'Chọn xem các tệp đã gửi có thể nhận kiểm tra ngữ pháp hay không.<br /><i>(Bạn cũng phải bật tùy chọn phản hồi về ngữ pháp trên tài khoản Turnitin của mình)</i>';
