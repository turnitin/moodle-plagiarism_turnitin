...
$string['ppagreement_default'] = 'Selezionando questa casella, confermo che questa consegna è frutto del mio lavoro e accetto ogni responsabilità per qualsiasi violazione del copyright che si può verificare in seguito a questa consegna.';
$string['ppagreement_desc'] = '<b>[Facoltativo]</b><br />Inserisci una dichiarazione di conferma del contratto per le consegne.<br />(<b>Nota:</b> se il contratto viene lasciato completamente vuoto non sarà richiesta alcuna conferma da parte degli studenti durante la consegna)';
$string['ppagreement'] = 'Esclusione di responsabilità / Contratto';
