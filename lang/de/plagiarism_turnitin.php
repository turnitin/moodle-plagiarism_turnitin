...
$string['enableperformancelogs_desc'] = 'Ist diese Option aktiviert, wird jede Anfrage an den Turnitin-Server in {tempdir}/plagiarism_turnitin/logs protokolliert.';
