...
$string['turnitinuseanon_desc_old'] = 'اختر ما اذا كنت ستسمح للتعليم المجهول عند تقييم الإرسالات.<br /><i>(هذا متوفر فقط للمستخدمين الذين يكون لديهم التعليم المجهول مكونًا في حساباتهم)</i>';
