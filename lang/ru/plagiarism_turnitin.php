...
$string['turnitinuseanon_desc_old'] = 'Этот параметр определяет возможность анонимной проверки отправленных работ.<br /><i>(Этот параметр доступен только в том случае, если в аккаунте пользователя настроена функция анонимности.)</i>';
