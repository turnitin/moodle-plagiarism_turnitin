...
$string['reportgenspeed_help'] = "Istnieją trzy opcje dla tego ustawienia zadania: „Generuj raporty natychmiast. Wysyłki zostaną natychmiast dodane do magazynu (jeśli magazyn został ustawiony)”. „Generuj raporty natychmiast. Wysyłki zostaną dodane do magazynu w danym terminie (jeśli magazyn został ustawiony)”. „Generuj raporty w danym terminie. Wysyłki zostaną dodane do magazynu w danym terminie (jeśli magazyn został ustawiony)”.<br /><br />Opcja „Generuj raporty natychmiast. Wysyłki zostaną dodane do magazynu w danym terminie (jeśli magazyn został ustawiony)” generuje raport oryginalności natychmiast po przesłaniu wysyłki przez studenta, a późniejsze wysyłki zostaną porównane z poprzednimi, jeśli były przechowywane w magazynie.<br /><br />Opcja „Generuj raporty natychmiast. Wysyłki zostaną dodane do magazynu w danym terminie (jeśli magazyn został ustawiony)” generuje raport oryginalności natychmiast po przesłaniu wysyłki przez studenta, a sprawdzenie zgodności nastąpi w terminie wykonania zadania, jeśli wysyłki były przechowywane w magazynie.<br /><br />Opcja „Generuj raporty w danym terminie. Wysyłki zostaną dodane do magazynu w danym terminie (jeśli magazyn został ustawiony)” generuje raport oryginalności, a sprawdzenie zgodności nastąpi w terminie wykonania zadania, jeśli wysyłki były przechowywane w magazynie.";
...
$string['nonsubmittingstudentinfo'] = "Aby wyświetlić raport Turnitin lub opinię dotyczącą pracy przesłanej przez grupę, skontaktuj się ze swoim instruktorem lub studentem, który przesłał pracę w imieniu Twojej grupy.";

$string['enableadhocsubmissions'] = "Włącz przetwarzanie zadań ad hoc dla kolejki wysyłek";
$string['adhoc_sendqueuedsubmission'] = "Zadanie ad-hoc: Prześlij wysyłkę z kolejki za pomocą wtyczki Turnitin Plagiarism Plugin";
