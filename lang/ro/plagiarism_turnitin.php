...
$string['ppagreement_default'] = 'Confirm că această depunere este munca mea și îmi asum toată răspunderea pentru orice violare a drepturilor de autor care se poate acea loc ca rezultat al acestei depuneri.';
$string['ppagreement_desc'] = '<b>[Opțional]</b><br />Introduceți o declarație de confirmare a acordului pentru depuneri.<br />(<b>Observație:</b> Dacă acordul este lăsat complet gol, studenților nu li se va cere nicio confirmare a acordului în momentul depunerii)';
$string['ppagreement'] = 'Exonerare de răspundere/Acord';
