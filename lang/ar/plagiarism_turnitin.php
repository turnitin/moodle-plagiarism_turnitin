...
$string['ppagreement_default'] = 'من خلال تأشير هذا المربع، اؤكد ان الارسال من عملي الخالص واتقبل جميع المسؤولية في حالة مخالفة حقوق النشر والملكية اذا ما نتج ذلك من خلال هذا الارسال';
$string['ppagreement_desc'] = '<b>[اختياري]</b><br />أدخل بيان تأكيد الاتفاق.<br />(<b>ملحوظة:</b> إذا ترك الاتفاق فارغًا تمامًا فلن يلزم وجود تأكيد اتفاق بواسطة الطلاب أثناء الإرسال)';
$string['ppagreement'] = 'اخلاء المسؤولية / الاتفاقية';
