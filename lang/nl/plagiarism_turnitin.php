...
$string['reportgenspeed_help'] = "Er zijn drie opties voor deze opdrachtinstelling: 'Rapporten onmiddellijk genereren. Inzendingen worden onmiddellijk aan de opslag toegevoegd (als de opslag is ingesteld)', 'Rapporten onmiddellijk genereren. Inzendingen worden op de inleverdatum aan de opslag toegevoegd (als de opslag is ingesteld)' en 'Rapporten op de inleverdatum genereren. Inzendingen worden op de inleverdatum aan de opslag toegevoegd (als de opslag is ingesteld)'.<br /><br />De optie 'Rapporten onmiddellijk genereren. Inzendingen worden onmiddellijk aan de opslag toegevoegd (als de opslag is ingesteld)' genereert direct als de student iets inlevert het originaliteitsrapport en latere inzendingen worden vergeleken met eerdere inzendingen als deze zijn opgeslagen.<br /><br />'Rapporten onmiddellijk genereren. Inzendingen worden op de inleverdatum aan de opslag toegevoegd (als de opslag is ingesteld)' genereert direct als de student iets inlevert een originaliteitsrapport en er vindt een collusiecheck plaats op de inleverdatum van de opdracht als de inzendingen zijn opgeslagen.<br /><br />De optie 'Rapporten op de inleverdatum genereren. Inzendingen worden op de inleverdatum aan de opslag toegevoegd (als de opslag is ingesteld)' genereert het originaliteitsrapport en voert een collusiecheck uit op de inleverdatum van de opdracht als de inzendingen zijn opgeslagen.";
...
$string['nonsubmittingstudentinfo'] = "Als je het Turnitin-rapport of -feedback voor deze groepsinzending wilt bekijken, neem je contact op met je docent of de student die de opdracht namens je groep heeft ingezonden.";

$string['enableadhocsubmissions'] = "Ad-hoc-taakverwerking inschakelen voor de inzendingsrij";
$string['adhoc_sendqueuedsubmission'] = "Ad-hoctaak: Verzend een in de wachtrij geplaatste inzending vanuit de plagiaat-plugin van Turnitin";
