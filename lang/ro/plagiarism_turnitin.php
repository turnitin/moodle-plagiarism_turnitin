...
$string['enableperformancelogs_desc'] = 'Dacă activați opțiunea, fiecare solicitare trimisă serverului Turnitin va fi înregistrată în jurnalele din {tempdir}/plagiarism_turnitin/logs';
