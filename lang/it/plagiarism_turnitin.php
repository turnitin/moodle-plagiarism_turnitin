...
$string['reportgenspeed_help'] = "Per questa impostazione del compito sono disponibili tre opzioni: \"Genera report all'istante. Le consegne verranno aggiunte subito all'archivio (se è stato impostato un archivio).\", \"Genera report all'istante. Le consegne verranno aggiunte all'archivio alla data di scadenza (se è stato impostato un archivio).\", \"Genera report alla data di scadenza. Le consegne verranno aggiunte all'archivio alla data di scadenza (se è stato impostato un archivio).\"<br /><br />L'opzione \"Genera report all'istante. Le consegne verranno aggiunte subito all'archivio (se è stato impostato un archivio).\" genera il report di originalità immediatamente quando uno studente effettua una consegna; le consegne successive vengono confrontate con le consegne precedenti se queste sono state aggiunte a un archivio.<br /><br />L'opzione \"Genera report all'istante. Le consegne verranno aggiunte all'archivio alla data di scadenza (se è stato impostato un archivio).\" genera un report di originalità immediatamente quando uno studente effettua una consegna; il controllo di collusione avviene alla data di scadenza del compito se le consegne sono state aggiunte a un archivio.<br /><br />L'opzione \"Genera report alla data di scadenza. Le consegne verranno aggiunte all'archivio alla data di scadenza (se è stato impostato un archivio).\" genera il report di originalità ed esegue un controllo di collusione alla data di scadenza del compito, se le consegne sono state aggiunte a un archivio.";
...
$string['nonsubmittingstudentinfo'] = "Per consultare il report o il feedback di Turnitin per questa consegna di gruppo, è necessario contattare il docente o lo studente che ha presentato il lavoro per conto del gruppo.";

$string['enableadhocsubmissions'] = "Abilita l'elaborazione del compito ad hoc per la coda di consegna";
$string['adhoc_sendqueuedsubmission'] = "Compito ad hoc: Invia una consegna in coda dal plugin di rilevamento del plagio di Turnitin";
