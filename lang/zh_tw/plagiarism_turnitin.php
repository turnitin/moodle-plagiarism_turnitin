...
$string["reportgen_immediate_add_immediate"] = "立即產生報告。 報告將立即新增至存放庫 (如果已設定存放庫)。";
$string["reportgen_immediate_add_duedate"] = "立即產生報告。報告將在截止日期新增至存放庫 (如果已設定存放庫)。";
...
$string['turnitinuseerater'] = '啟用文法意見反應';
$string['turnitinuseerater_desc'] = '選擇提交的檔案是否可以收到文法檢查。<br /><i>(還必須在 Turnitin 帳戶上啟用文法意見反應)</i>';
