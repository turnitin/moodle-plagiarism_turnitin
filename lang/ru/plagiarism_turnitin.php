...
$string['reportgenspeed_help'] = "Существует три варианта настройки этого задания: \"Генерировать отчеты сразу. Представленные работы будут сразу же добавлены в хранилище (если хранилище установлено)\", \"Генерировать отчеты сразу. Представленные работы будут добавлены в хранилище в установленный срок (если хранилище установлено)\" и \"Генерировать отчеты в установленный срок. Представленные работы будут добавлены в хранилище в установленный срок (если хранилище установлено)\".<br /><br />Вариант \"Генерировать отчеты сразу. Представленные работы будут сразу же добавлены в хранилище (если хранилище установлено)\" генерирует отчет об оригинальности сразу, как только студент отправит работу, а последующие представленные работы будут сравниваться с предыдущими, если они были сохранены в хранилище.<br /><br />Вариант \"Генерировать отчеты сразу. Представленные работы будут добавлены в хранилище в установленный срок (если хранилище установлено)\" генерирует отчет об оригинальности сразу же, как только студент отправит работу, а проверка на недобросовестность произойдет в установленный срок, если представленные работы были сохранены в хранилище.<br /><br />Вариант \"Генерировать отчеты в установленный срок. Представленные работы будут добавлены в хранилище в установленный срок (если хранилище установлено)\" генерирует отчет об оригинальности и выполняет проверку на недобросовестность в установленный срок выполнения задания, если представленные работы были сохранены в хранилище.";
...
$string['nonsubmittingstudentinfo'] = "Чтобы просмотреть отчет Turnitin об этой групповой работе или отзыв о ней, обратитесь к своему преподавателю или к студенту, представившему работу от имени группы.";

$string['enableadhocsubmissions'] = "Включить обработку ситуативных задач для очереди представлений";
$string['adhoc_sendqueuedsubmission'] = "Ситуативная задача: Отправка представлений в очереди из подключаемого модуля предотвращения плагиата Turnitin";
