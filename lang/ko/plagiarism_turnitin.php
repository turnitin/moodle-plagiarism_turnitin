...
/**
 * Strings for component 'plagiarism_turnitin', language 'ko'
 *
...
$string['turnitinuseerater'] = '문법 피드백 활성화';
$string['turnitinuseerater_desc'] = '제출된 파일이 문법 검사를 받을 수 있는지 선택하십시오<br /><i>(문법 피드백은 Turnitin 계정에서도 활성화되어야 함)</i>';
