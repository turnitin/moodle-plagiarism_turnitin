...
$string['turnitinuseanon_desc_old'] = 'Wybierz, czy zezwolić na anonimowe poprawki przy ocenianiu wysyłek.<br /><i>(opcja dostępna tylko dla użytkowników konta ze skonfigurowaną funkcją anonimowych poprawek)</i>';
