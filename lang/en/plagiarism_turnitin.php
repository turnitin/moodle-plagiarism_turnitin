...
$string['pending'] = 'Pending';
$string['because'] = 'This was because an administrator deleted the pending assignment from the processing queue and aborted the submission to Turnitin. <strong>The file still exists in Moodle.</strong> Please see below for any error codes.';
