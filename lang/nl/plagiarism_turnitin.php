...
$string['turnitinuseanon_desc_old'] = 'Kies of Anonieme beoordeling is toegestaan bij het beoordelen van inzendingen.<br /><i>(Dit is alleen beschikbaar voor degenen die Anonieme beoordeling hebben geconfigureerd voor hun account)</i>';
