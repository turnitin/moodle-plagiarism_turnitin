...
$string["reportgen_immediate_add_immediate"] = "立即生成报告。报告将立即添加到存储库中（如果设置了存储库）。";
$string["reportgen_immediate_add_duedate"] = "立即生成报告。报告将在截止日期添加到存储库中（如果设置了存储库）。";
$string["reportgen_duedate_add_duedate"] = "在截止日期生成报告。报告将在截止日期添加到存储库中（如果设置了存储库）。";
...
$string['turnitinuseerater'] = '启用语法反馈';
$string['turnitinuseerater_desc'] = '选择提交的文件是否可以接受语法检查。<br /><i>（还必须在您的 Turnitin 帐户上启用语法反馈）</i>';
