...
$string['ppagreement_default'] = 'Bu kutuyu işaretleyerek, bu gönderinin kendi çalışmam olduğunu onaylıyor ve bu gönderi sonrasında ortaya çıkabilecek telif hakkı ihlalinin sorumluluğunu kabul ediyorum.';
$string['ppagreement_desc'] = '<b>[İsteğe Bağlı]</b><br />Bu gönderi için bir sözleşme onayı ifadesi girin.<br />(<b>Not:</b> Sözleşme boş bırakıldıysa, öğrenci ödev gönderimi sırasında sözleşme onayı gerekmeyecektir)';
$string['ppagreement'] = 'Feragatname / Sözleşme';
