...
$string['reportgenspeed_help'] = "Há três opções para essa configuração de atribuição: \"Gerar relatórios imediatamente. As entregas serão adicionadas ao repositório imediatamente (se o repositório estiver definido).\", \"Gerar relatórios imediatamente. As entregas serão adicionadas ao repositório na data de vencimento (se o repositório estiver definido).\" e \"Gerar relatórios na data de vencimento. As entregas serão adicionadas ao repositório na data de vencimento (se o repositório estiver definido).\"<br /><br />A opção \"Gerar relatórios imediatamente. As entregas serão adicionadas ao repositório imediatamente (se o repositório estiver definido).\" gera o Relatório de originalidade imediatamente quando um aluno faz uma entrega e as entregas posteriores serão comparadas com as entregas anteriores se as entregas foram armazenadas em um repositório.<br /><br />\"Gerar relatórios imediatamente. As entregas serão adicionadas ao repositório na data de vencimento (se o repositório estiver definido).\" gera um Relatório de originalidade imediatamente quando um aluno faz uma entrega e a verificação de conluio ocorrerá na data de vencimento da tarefa se as entregas foram armazenadas em um repositório.<br /><br />A opção \"Gerar relatórios na data de vencimento. As entregas serão adicionadas ao repositório na data de vencimento (se o repositório estiver definido).\" gera o Relatório de originalidade e realiza uma verificação de conluio na data de vencimento da tarefa se as entregas foram armazenadas em um repositório.";
...
$string['nonsubmittingstudentinfo'] = "Para visualizar o relatório ou os comentários das entregas desse grupo, entre em contato com seu professor ou o aluno que fez a entrega em nome do grupo.";

$string['enableadhocsubmissions'] = "Habilite o processamento de tarefas sob demanda na fila de entregas";
$string['adhoc_sendqueuedsubmission'] = "Tarefa sob demanda: Envie uma entrega da fila pelo Plugin de plágio do Turnitin";
