...
$string['reportgenspeed_help'] = "Pro toto nastavení úkolu existují tři možnosti: 'Generovat zprávy okamžitě. Odevzdání budou okamžitě přidána do úložiště (pokud je úložiště nastaveno). 'Generovat zprávy okamžitě. Odevzdání budou přidána do úložiště v termínu dokončení (pokud je úložiště nastaveno).' a 'Generovat zprávy v termínu dokončení. Odevzdání budou přidána do úložiště v termínu dokončení (pokud je úložiště nastaveno).'<br /><br />Možnost 'Generovat zprávy okamžitě. Odevzdání budou okamžitě přidána do úložiště (pokud je úložiště nastaveno).' vygeneruje zprávu původnosti ihned, jakmile student odevzdá práci. Zároveň se později odevzdané práce porovnají s předchozími odevzdáními, pokud tyto byly uloženy v úložišti.<br /><br />'Generovat zprávy okamžitě. Odevzdání budou přidána do úložiště v termínu dokončení (pokud je úložiště nastaveno).' vygeneruje zprávu původnosti ihned, jakmile student odevzdá práci. Zároveň se v termínu dokončení provede kontrola koluze, pokud byly odevzdané práce uloženy v úložišti.<br /><br />Možnost 'Generovat zprávy okamžitě. Odevzdání budou přidána do úložiště v termínu dokončení (pokud je úložiště nastaveno).' v termínu dokončení vygeneruje zprávu původnosti a provede kontrolu koluze, pokud byly odevzdané práce uloženy v úložišti.";
...
$string['nonsubmittingstudentinfo'] = "Pokud chcete zobrazit zprávu Turnitin nebo zpětnou vazbu pro toto skupinové odevzdání, obraťte se buď na svého instruktora, nebo na studenta, který provedl odevzdání jménem vaší skupiny.";

$string['enableadhocsubmissions'] = "Povolit zpracování ad hoc úloh ve frontě odevzdání";
$string['adhoc_sendqueuedsubmission'] = "Ad hoc úloha: Odeslat odevzdání čekající ve frontě z pluginu Turnitin Plagiarism";
