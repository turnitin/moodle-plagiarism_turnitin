...
/**
 * Strings for component 'plagiarism_turnitin', language 'ja'
 *
...
$string['turnitinuseerater'] = '文法フィードバックをオンに設定';
$string['turnitinuseerater_desc'] = '提出したファイルを文法チェックの対象とするか選択してください<br /><i>（Turnitinアカウントで文法フィードバックもオンに設定する必要があります）</i>';
