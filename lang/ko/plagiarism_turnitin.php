...
$string['reportgenspeed_help'] = "이 과제 설정에 대해 3가지 옵션이 있습니다. '보고서를 즉시 생성합니다. 제출물이 데이터베이스에 바로 추가됩니다(데이터베이스가 설정된 경우).', '보고서를 즉시 생성합니다. 제출물이 마감일에 데이터베이스에 추가됩니다(데이터베이스가 설정된 경우).', '보고서를 마감일에 생성합니다. 제출물이 마감일에 데이터베이스에 추가됩니다(데이터베이스가 설정된 경우).'<br /><br />'보고서를 즉시 생성합니다. 제출물이 데이터베이스에 바로 추가됩니다(데이터베이스가 설정된 경우).' 옵션은 학생이 제출물을 제출할 때 즉시 독창성 보고서를 생성하며 제출물이 데이터베이스에 저장된 경우 마감 후 제출물을 이전 제출물과 비교합니다.<br /><br />'보고서를 즉시 생성합니다. 제출물이 마감일에 데이터베이스에 추가됩니다(데이터베이스가 설정된 경우).' 옵션은 학생이 제출물을 제출할 때 즉시 독창성 보고서를 생성하며 제출물이 데이터베이스에 저장된 경우 과제 마감일에 공모 검사를 수행합니다.<br /><br />'보고서를 마감일에 생성합니다. 제출물이 마감일에 데이터베이스에 추가됩니다(데이터베이스가 설정된 경우).' 옵션은 독창성 보고서를 생성하며 제출물이 데이터베이스에 저장된 경우 과제 마감일에 공모 검사를 수행합니다.";
$string['turnitinuseanon_desc'] = '제출물을 채점할 때 익명 채점을 허용할 것인지 결정하십시오.<br /><i>(이는 계정에 익명 채점이 구성되어 있는 분만 사용할 수 있습니다)</i>';
$string['nonsubmittingstudentinfo'] = "이 그룹 과제에 대한 Turnitin 보고서 또는 피드백을 보려면 해당 그룹을 대표하여 과제를 제출한 학생이나 담당 강사에게 문의하세요.";

$string['enableadhocsubmissions'] = "제출물 대기열에 대한 임시 작업 처리 활성화";
$string['adhoc_sendqueuedsubmission'] = "임시 작업: Turnitin 표절 플러그인에서 대기 중인 제출물 전송";
