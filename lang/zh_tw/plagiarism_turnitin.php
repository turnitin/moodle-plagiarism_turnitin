...
$string['turnitinuseerater'] = '啟用 ETS&copy;';
$string['turnitinuseerater_desc'] = '選擇是否開啟 ETS&copy; 文法檢查。<br /><i>(唯有您的 Turnitin帳戶已啟用 ETS&copy; e-rater 的情況下，才能啟用此選項)</i>';
...
$string['ppagreement_default'] = '我確認所提交物件是我自己的作品，同時接受所有可能因提交此物件造成著作權侵權之責任。';
$string['ppagreement_desc'] = '<b>[選擇性]</b><br />輸入一個提交時協議確認聲明。<br />(<b>注意：</b>如果完全空白的協議，學生在提交時就不需要確認協議)';
$string['ppagreement'] = '免責聲明/協議';
