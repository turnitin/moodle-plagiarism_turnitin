...
$string['reportgenspeed_help'] = "Det finns tre alternativ för den här uppgiftsinställningen: Generera rapporter omedelbart – inlämningar läggs till i arkivet omedelbart (om arkivet är konfigurerat). Generera rapporter omedelbart – inlämningar läggs till i arkivet på förfallodatumet (om arkivet är konfigurerat). Generera rapporter på förfallodatumet – inlämningar läggs till i arkivet på förfallodatumet (om arkivet är konfigurerat).<br /><br />Alternativet ”Generera rapporter omedelbart – inlämningar läggs till i arkivet omedelbart (om arkivet är konfigurerat)” genererar originalitetsrapporten omedelbart när en student lämnar in uppgiften och senare inlämningar jämförs med tidigare om de sparades i ett arkiv.<br /><br />Alternativet ”Generera rapporter omedelbart – inlämningar läggs till i arkivet på förfallodatumet (om arkivet är konfigurerat)” genererar originalitetsrapporten omedelbart när en student lämnar in uppgiften och samverkanskontrollen sker på uppgiftens förfallodatum om inlämningarna sparades i ett arkiv.<br /><br />Alternativet ”Generera rapporter på förfallodatumet – inlämningar läggs till i arkivet på förfallodatumet (om arkivet är konfigurerat)” genererar originalitetsrapporten och utför en samverkanskontroll på uppgiftens förfallodatum om inlämningarna sparades i ett arkiv.";
...
$string['nonsubmittingstudentinfo'] = "Om du vill visa Turnitin-rapporten eller återkopplingen för denna gruppinlämning kontaktar du handledaren eller studenten som lämnade in den för gruppens räkning.";

$string['enableadhocsubmissions'] = "Aktivera bearbetning av ad-hoc-uppgifter för inlämningskön";
$string['adhoc_sendqueuedsubmission'] = "Ad-hoc-uppgift: Skicka en köad inlämning från Turnitin Plagiarism-plugin";
