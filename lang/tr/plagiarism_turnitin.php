...
$string['erater'] = 'Dil bilgisi geri bildirimini etkinleştirin';
...
$string["reportgen_immediate_add_immediate"] = "Raporları anında oluşturun. Raporlar, depoya anında eklenecektir (depo ayarlanmışsa).";
$string["reportgen_immediate_add_duedate"] = "Raporları anında oluşturun. Raporlar, depoya teslim tarihinde eklenecektir (depo ayarlanmışsa).";
$string["reportgen_duedate_add_duedate"] = "Raporları teslim tarihinde oluşturun. Raporlar, depoya teslim tarihinde eklenecektir (depo ayarlanmışsa).";
...
$string['turnitinuseerater'] = 'Dil bilgisi geri bildirimini etkinleştirin';
$string['turnitinuseerater_desc'] = 'Gönderilen dosyalarda dil bilgisi kontrolü yapılıp yapılamayacağını seçin.<br /><i>(Bunun için, dil bilgisi geri bildirimi, Turnitin hesabınızda da etkinleştirilmelidir)</i>';
