...
$string['reportgenspeed_help'] = "هناك ثلاثة خيارات لإعداد هذه المهمة: \"إنشاء التقارير على الفور. ستتم إضافة التسليمات إلى المستودع على الفور (إذا تم تعيين المستودع)، و\"إنشاء التقارير على الفور. ستتم إضافة التسليمات إلى المستودع في تاريخ الاستحقاق (إذا تم تعيين المستودع)، و\"إنشاء التقارير في تاريخ الاستحقاق. ستتم إضافة التسليمات إلى المستودع في تاريخ الاستحقاق (إذا تم تعيين المستودع).\"<br /> <br />الخيار \"إنشاء التقارير على الفور. سيتم إضافة التسليمات إلى المستودع على الفور (إذا تم تعيين المستودع)\" إلى إنشاء تقرير الأصالة على الفور عندما يقوم الطالب بإرسال تسليم، وستتم مقارنة التسليمات اللاحقة بالتسليمات السابقة إذا تم تخزين التسليمات في مستودع.<br /><br />\"إنشاء التقارير على الفور. سيتم إضافة التسليمات إلى المستودع في تاريخ الاستحقاق (إذا تم تعيين المستودع).\" يتم إنشاء تقرير الأصالة على الفور عندما يقوم الطالب بتقديم تسليم ما، وسيتم إجراء فحص التواطؤ في تاريخ استحقاق المهمة إذا تم تخزين التسليمات في المستودع.<br /><br />يؤدي الخيار \"إنشاء التقارير في تاريخ الاستحقاق. سيتم إضافة التسليمات إلى المستودع في تاريخ الاستحقاق (إذا تم تعيين المستودع)\" إلى إنشاء تقرير الأصالة وإجراء فحص التواطؤ في تاريخ استحقاق المهمة إذا تم تخزين التسليمات في مستودع.";
