...
class pp_receipt_message {
    ...
    public function build_message($input) {
        ...
        return format_string(get_string('pp_digital_receipt_message', 'plagiarism_turnitin', $message));
    }
    ...
    public function build_instructor_message($input) {
        ...
        return format_string(get_string('receipt_instructor_copy', 'plagiarism_turnitin', $message));
    }
