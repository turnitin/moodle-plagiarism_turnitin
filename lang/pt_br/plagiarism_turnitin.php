...
$string['ppagreement_default'] = 'Ao selecionar essa caixa, eu confirmo que este envio é o meu próprio trabalho e eu aceito toda a responsabilidade por qualquer infração que possam ocorrer como resultado deste envio.';
$string['ppagreement_desc'] = '<b>[Opcional]</b><br />Digite uma declaração de confirmação de acordo para os envios.<br />(<b>Observação:</b> Se o acordo for deixado completamente em branco, nenhuma confirmação de acordo será exigida dos alunos durante o envio)';
$string['ppagreement'] = 'Aviso Legal / Acordo';
