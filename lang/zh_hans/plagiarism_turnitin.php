...
$string['ppagreement_default'] = '我确认此提交内容是我的作品，并且接受所有可能因此提交而产生的侵权的责任。';
$string['ppagreement_desc'] = '<b>[可选]</b><br />输入协议确认声明以供提交。<br />（<b>注意：</b>如果协议完全留空，则学生在提交时就无需确认协议）';
$string['ppagreement'] = '免责声明/协议';
