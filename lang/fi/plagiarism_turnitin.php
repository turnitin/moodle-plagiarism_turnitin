...
$string['reportgenspeed_help'] = "Tälle tehtäväasetukselle on olemassa kolme vaihtoehtoa: \"Luo raportit välittömästi. Palautukset lisätään arkistoon välittömästi (jos arkisto on määritetty).\", \"Luo raportit välittömästi. Palautukset lisätään arkistoon palautuspäivänä (jos arkisto on määritetty).\", \"Luo raportit palautuspäivänä. Palautukset lisätään arkistoon palautuspäivänä (jos arkisto on määritetty).\"<br /><br />Vaihtoehto \"Luo raportit välittömästi. Palautukset lisätään arkistoon välittömästi (jos arkisto on määritetty).\" luo alkuperäisyysraportin välittömästi, kun opiskelija palauttaa tehtävän, ja myöhäisiä palautuksia verrataan aiempiin palautuksiin, jos palautuksia säilytetään arkistossa.<br /><br />Vaihtoehto \"Luo raportit välittömästi. Palautukset lisätään arkistoon palautuspäivänä (jos arkisto on määritetty).\" luo alkuperäisyysraportin välittömästi, kun opiskelija palauttaa tehtävän, ja vilppitarkastus suoritetaan tehtävän palautuspäivänä, jos palautuksia säilytetään arkistossa.<br /><br />Vaihtoehto \"Luo raportit palautuspäivänä. Palautukset lisätään arkistoon palautuspäivänä (jos arkisto on määritetty).\" luo alkuperäisyysraportin ja suorittaa vilppitarkastuksen tehtävän palautuspäivänä, jos palautuksia säilytetään arkistossa.";
...
$string['nonsubmittingstudentinfo'] = "Jos haluat tarkastella tämän ryhmäpalautuksen Turnitin-raporttia tai palautetta, ota yhteyttä joko ohjaajaasi tai opiskelijaan, joka palautti työn ryhmäsi puolesta.";

$string['enableadhocsubmissions'] = "Ota tehtäväkohtainen ad-hoc-käsittely käyttöön palautusjonolle";
$string['adhoc_sendqueuedsubmission'] = "Ad-hoc-tehtävä: Lähetä jonossa oleva palautus Turnitinin plagiointi-pluginista";
