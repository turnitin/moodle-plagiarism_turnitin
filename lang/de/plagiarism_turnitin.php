...
$string['reportgenspeed_help'] = "Für diese Aufgabe gibt es drei Optionen: „Berichte sofort erstellen. Einreichungen werden sofort zum Repository hinzugefügt (sofern ein Repository festgelegt ist)“, „Berichte sofort erstellen. Einreichungen werden am Abgabedatum zum Repository hinzugefügt (sofern ein Repository festgelegt ist)“ und „Berichte am Abgabedatum erstellen. Einreichungen werden am Abgabedatum zum Repository hinzugefügt (sofern ein Repository festgelegt ist)“.<br /><br />Die Option „Berichte sofort erstellen. Einreichungen werden sofort zum Repository hinzugefügt (sofern ein Repository festgelegt ist)“ generiert den Originalitätsbericht sofort, wenn ein Student eine Einreichung vornimmt, und spätere Einreichungen werden mit früheren Einreichungen verglichen, wenn die Einreichungen in einem Repository gespeichert wurden.<br /><br />„Berichte sofort erstellen. Einreichungen werden am Abgabedatum zum Repository hinzugefügt (sofern ein Repository festgelegt ist)“ erstellt sofort einen Originalitätsbericht, wenn ein Student eine Einreichung vornimmt, und führt am Abgabedatum der Aufgabe eine Kollusionsprüfung durch, wenn die Einreichungen in einem Repository gespeichert wurden.<br /><br />Die Option „Berichte am Abgabedatum erstellen. Einreichungen werden am Abgabedatum zum Repository hinzugefügt (sofern ein Repository festgelegt ist)“ erstellt den Originalitätsbericht und führt am Abgabedatum der Aufgabe eine Kollusionsprüfung durch, wenn die Einreichungen in einem Repository gespeichert wurden.";
...
$string['nonsubmittingstudentinfo'] = "Wenn Sie den Turnitin-Bericht oder das Feedback für diese Gruppeneinreichung einsehen möchten, wenden Sie sich an Ihre Lehrkraft oder die Person, die im Namen Ihrer Gruppe eingereicht hat.";

$string['enableadhocsubmissions'] = "Ad-hoc-Aufgabenverarbeitung für die Einreichungswarteschlange aktivieren";
$string['adhoc_sendqueuedsubmission'] = "Ad-hoc-Aufgabe: Eine in der Warteschlange befindliche Einreichung aus dem Turnitin-Plagiats-Plugin senden";
