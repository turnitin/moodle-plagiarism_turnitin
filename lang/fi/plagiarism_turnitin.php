...
$string['turnitinuseanon_desc_old'] = 'Valitse haluatko sallia Nimettömän Merkinnän palautuksien arvostelussa.<br /><i>(Tämä edellyttää, että tilille on määritetty Nimetön Merkintä -asetus)</i>';
