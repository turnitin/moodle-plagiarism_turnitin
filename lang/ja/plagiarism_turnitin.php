...
$string['ppagreement_default'] = 'このボックスをチェックすることによって、私はこの提出物が私自身の物であることを確認し、この提出物に関しての全ての著作権侵害の責任を負うこと誓います。';
$string['ppagreement_desc'] = '<b>[オプション]</b><br />提出物への同意確認を入力してください。<br />（<b>注意：</b>同意欄が空白のまま残されると、学生の提出時に同意確認を要求しません）';
$string['ppagreement'] = '免責事項／契約';
