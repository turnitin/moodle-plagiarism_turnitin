...
$string['ppagreement_default'] = 'Ik bevestig dat deze inzending mijn eigen werk is en ik accepteer alle verantwoordelijkheid voor eventuele auteursrechtschendingen die kunnen optreden als gevolg van deze inzending.';
$string['ppagreement_desc'] = '<b>[Optioneel]</b><br />Voer een bevestigingsverklaring voor de overeenkomst in voor inzendingen.<br />(<b>Opmerking:</b> als de overeenkomst blanco wordt gelaten, is er geen bevestiging van de overeenkomst vereist voor studenten tijdens het indienen)';
$string['ppagreement'] = 'Disclaimer/Overeenkomst';
