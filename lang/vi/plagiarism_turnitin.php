...
$string['turnitinuseanon_desc_old'] = 'Chọn có hay không cho phép Chấm điểm Ẩn danh khi chấm các bài nộp.<br /><i>(Tùy chọn này chỉ khả dụng cho những ai có tài khoản được định cấu hình Chấm điểm Ẩn danh)</i>';
