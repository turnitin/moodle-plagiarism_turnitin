...
$string['erater'] = 'Aktivera grammatikrespons';
...
$string["reportgen_immediate_add_immediate"] = "Generera rapporter omedelbart. Rapporter läggs till i arkivet omedelbart (om arkivet är konfigurerat).";
$string["reportgen_immediate_add_duedate"] = "Generera rapporter omedelbart. Rapporter läggs till i arkivet på förfallodatum (om arkivet är konfigurerat).";
$string["reportgen_duedate_add_duedate"] = "Generera rapporter på förfallodatumet. Rapporter läggs till i arkivet på förfallodatumet (om arkivet är konfigurerat).";
...
$string['turnitinuseerater'] = 'Aktivera grammatikrespons';
$string['turnitinuseerater_desc'] = 'Ange om inlämnade filer får genomgå en grammatikkontroll.<br /><i>(Grammatikrepons måste också vara aktiverad i ditt Turnitin-konto.)</i>';
