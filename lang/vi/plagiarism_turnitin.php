...
$string['reportgenspeed_help'] = "Có ba tùy chọn cho chế độ cài đặt bài tập này: 'Tạo báo cáo ngay lập tức. Bài nộp sẽ được thêm vào kho dữ liệu ngay lập tức (nếu kho dữ liệu được thiết lập).', 'Tạo báo cáo ngay lập tức. Bài nộp sẽ được thêm vào kho dữ liệu vào ngày đến hạn (nếu kho dữ liệu được thiết lập).', và 'Tạo báo cáo vào ngày đến hạn. Bài nộp sẽ được thêm vào kho lưu trữ vào ngày đến hạn (nếu kho lưu trữ được thiết lập).'<br /><br />Tùy chọn 'Tạo báo cáo ngay lập tức. Bài nộp sẽ được thêm vào kho dữ liệu ngay lập tức (nếu kho dữ liệu được thiết lập).' sẽ tạo Báo cáo về tính nguyên gốc ngay lập tức khi học viên nộp bài và các bài nộp sau đó sẽ so sánh với các bài nộp trước đó nếu các bài nộp đó được lưu trữ trong kho dữ liệu.<br /><br />'Tạo báo cáo ngay lập tức. Bài nộp sẽ được thêm vào kho dữ liệu vào ngày đến hạn (nếu kho dữ liệu được thiết lập).' sẽ tạo Báo cáo về tính nguyên gốc ngay lập tức khi học viên nộp bài và quy trình thực hiện kiểm tra đạo văn giữa các bài nộp sẽ diễn ra vào ngày đến hạn của bài tập nếu các bài nộp được lưu trữ trong kho dữ liệu.<br /><br />Tùy chọn 'Tạo báo cáo vào ngày đến hạn. Bài nộp sẽ được thêm vào kho dữ liệu vào ngày đến hạn (nếu kho dữ liệu được thiết lập).' sẽ tạo Báo cáo về tính nguyên gốc và thực hiện kiểm tra đạo văn giữa các bài nộp vào ngày đến hạn của bài tập nếu các bài nộp được lưu trữ trong kho dữ liệu.";
...
$string['nonsubmittingstudentinfo'] = "Để xem báo cáo củaTurnitin hoặc phản hồi cho bài nộp nhóm này, vui lòng liên hệ với người hướng dẫn hoặc học viên đã nộp bài thay mặt cho nhóm của bạn.";

$string['enableadhocsubmissions'] = "Cho phép xử lý tác vụ tùy chỉnh cho hàng đợi bài nộp";
$string['adhoc_sendqueuedsubmission'] = "Tác vụ tùy chỉnh: Gửi bài nộp trong hàng đợi từ Plugin chống đạo văn của Turnitin";
