...
$string['turnitinuseanon_desc_old'] = 'Scegli se consentire la valutazione anonima per le consegne.<br /><i>(Disponibile solo per chi ha configurato la valutazione anonima per il proprio account)</i>';
