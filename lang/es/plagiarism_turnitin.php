...
$string['turnitinuseanon_desc_old'] = 'Selecciona si deseas permitir Correcciones anónimas para evaluar entregas.<br /><i>(Esta opción solo está disponible para aquellos que han configurado las correcciones anónimas en sus cuentas)</i>';
