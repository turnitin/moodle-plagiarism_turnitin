...
$string['reportgenspeed_help'] = "Existen tres opciones para la configuración de ejercicios: \"Genera informes inmediatamente. Los envíos se agregarán al repositorio de inmediato (si se ha configurado un repositorio)\", \"Genera informes inmediatamente. Los envíos se agregarán al repositorio en la fecha límite de entrega (si se ha configurado un repositorio)\" y \"Genera informes en la fecha límite de entrega. Los envíos se agregarán al repositorio en la fecha límite de entrega (si se ha configurado un repositorio)\".<br /><br />La opción \"Genera informes inmediatamente. Los envíos se agregarán al repositorio de inmediato (si se ha configurado un repositorio)\" crea el informe de originalidad justo en el momento en el que un estudiante realiza una entrega, y todas las entregas siguientes se compararán con las anteriores, siempre que se hayan almacenado en un repositorio.<br /><br />La opción \"Genera informes inmediatamente. Los envíos se agregarán al repositorio en la fecha límite de entrega (si se ha configurado un repositorio)\" crea un informe de originalidad justo en el momento en el que un estudiante realiza una entrega, y las comparaciones y comprobaciones se realizarán en la fecha de límite de entrega del ejercicio, siempre que los envíos se hayan almacenado en un repositorio.<br /><br />La opción \"Genera informes en la fecha límite de entrega. Los envíos se agregarán al repositorio en la fecha límite de entrega (si se ha configurado un repositorio)\" crea un informe de originalidad, y las comparaciones y comprobaciones se realizarán en la fecha límite de entrega del ejercicio, siempre que los envíos se hayan almacenado en un repositorio.";
...
$string['nonsubmittingstudentinfo'] = "Para ver el reporte de Turnitin o la retroalimentación correspondiente a esta entrega de grupo, ponte en contacto con tu instructor o con el estudiante que realizó la entrega en nombre de tu grupo.";

$string['enableadhocsubmissions'] = "Habilita el procesamiento de tareas bajo demanda para la cola de entregas";
$string['adhoc_sendqueuedsubmission'] = "Tarea bajo demanda: Envía una entrega pendiente del plugin de plagio de Turnitin";
