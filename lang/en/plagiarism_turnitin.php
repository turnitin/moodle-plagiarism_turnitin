...
$string['checkagainstnote'] = 'Note: If you do not select "Yes" for at least one of the "Check against..." options below then an similarity report will NOT be generated.';
...
$string['notorcapable'] = 'It is not possible to produce an Similarity Report for this file.';
...
$string['errorcode1'] = 'This file has not been sent to Turnitin as it does not have enough content to produce an Similarity Report.';
...
$string['privacy:metadata:plagiarism_turnitin_files:orcapable'] = 'Indicates whether Turnitin was able to produce an similarity report for the user\'s submission.';
