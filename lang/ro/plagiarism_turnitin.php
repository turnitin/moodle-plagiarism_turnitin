...
$string['reportgenspeed_help'] = "Există trei opțiuni pentru această setare de temă: „Generați rapoarte imediat. Depunerile vor fi adăugate în depozit imediat (dacă depozitul este setat).” „Generați rapoarte imediat. Depunerile vor fi adăugate în depozit la termenul de depunere (dacă depozitul este setat).” „Generați rapoarte la termenul de depunere. Depunerile vor fi adăugate în depozit la termenul de depunere (dacă depozitul este setat).”<br /><br />Opțiunea „Generați rapoarte imediat. Depunerile vor fi adăugate în depozit imediat (dacă depozitul este setat).” generează imediat Raportul privind originalitatea atunci când un student face o depunere, iar depunerile cu întârziere vor fi comparate cu depunerile anterioare dacă depunerile au fost stocate într-un depozit.<br /><br />„Generați rapoarte imediat. Depunerile vor fi adăugate în depozit la termenul de depunere (dacă depozitul este setat).” generează imediat un Raport privind originalitatea atunci când un student face o depunere, iar verificarea prezenței coluziunii se va produce la termenul de depunere dacă depunerile au fost stocate într-un depozit.<br /><br />Opțiunea „Generați rapoarte la termenul de depunere. Depunerile vor fi adăugate în depozit la termenul de depunere (dacă depozitul este setat).” generează Raportul privind originalitatea și realizează o verificare a prezenței coluziunii la termenul de depunere a temei dacă depunerile au fost stocate într-un depozit.";
...
$string['nonsubmittingstudentinfo'] = "Pentru a vizualiza raportul Turnitin sau feedbackul pentru această depunere de grup, vă rugăm să contactați profesorul sau studentul care a efectuat depunerea în numele grupului dvs.";

$string['enableadhocsubmissions'] = "Activați procesarea sarcinilor ad-hoc pentru coada de depuneri";
$string['adhoc_sendqueuedsubmission'] = "Sarcină ad-hoc: Trimiteți o depunere aflată în coadă din pluginul Turnitin Plagiarism";
