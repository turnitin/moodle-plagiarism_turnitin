...
$string['turnitinremotelogging'] = 'Enable Remote Logging';
$string['turnitindiagnostic_desc'] = '<b>[Caution]</b><br />Enable Diagnostic mode only to track down problems with the Turnitin API.';
$string['turnitinremotelogging_desc'] = 'Logs will automatically be sent to Turnitin for diagnostic purposes. No private data is transferred. We recommend this setting remains enabled so we can quickly provide support if needed. However, logs can still be found in your Moodle environment to manually send to Turnitin.';
