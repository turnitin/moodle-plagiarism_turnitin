...
$string['ppagreement_default'] = 'Отмечая это окно, я подтверждаю, что это представление является моей собственной работой и я принимаю на себя всю тветственность за любое нарушение авторских прав, которое может появиться в результате этого представления.';
$string['ppagreement_desc'] = '<b>[Необязательно]</b><br />Введите заявление о согласии для отправки работ.<br />(<b>Примечание:</b> если оставить поле для заявления пустым, при отправке работ студентам не потребуется подтверждать свое согласие)';
$string['ppagreement'] = 'Заявление об авторских правах/соглашение';
