...
$string['ppagreement_default'] = 'Potwierdzam autorstwo tej przesyłki i przyjmuję pełną odpowiedzialność, jaka może wyniknąć z naruszenia praw autorskich w związku z tą przesyłką.';
$string['ppagreement_desc'] = '<b>[Opcjonalnie]</b><br />Wprowadź formułę potwierdzenia umowy dla wysyłek.<br />(<b>Uwaga:</b> Pozostawienie pustego pola oznacza, że nie wymaga się potwierdzenia umowy od studentów)';
$string['ppagreement'] = 'Zrzeczenie się / Umowa';
