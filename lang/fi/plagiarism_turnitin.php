...
$string['ppagreement_default'] = 'Merkitsemällä tämän ruudun vahvistan että palautus on minun oma työni ja otan vastuulleni kaikki, palautukseni tuloksena mahdollisesti ilmenneet tekijänoikeuden rikkomiset.';
$string['ppagreement_desc'] = '<b>[Valinnainen]</b><br />Syötä palautuksille sopimusvahvistuslausunto.<br />(<b>Huomaa:</b> Jos sopimus on jätetty täysin tyhjäksi, ei opiskelijoilta vaadita sopimusvahvistusta palautuksen yhteydessä)';
$string['ppagreement'] = 'Vastuuvapauslauseke / Sopimus';
