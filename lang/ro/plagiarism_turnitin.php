...
$string['erater'] = 'Activați feedbackul gramatical';
...
$string["reportgen_immediate_add_immediate"] = "Generați rapoarte imediat. Rapoartele vor fi adăugate în depozit imediat (dacă depozitul este setat).";
$string["reportgen_immediate_add_duedate"] = "Generați rapoarte imediat. Rapoartele vor fi adăugate în depozit la termenul de depunere (dacă depozitul este setat).";
$string["reportgen_duedate_add_duedate"] = "Generați rapoarte la termenul de depunere. Rapoartele vor fi adăugate în depozit la termenul de depunere (dacă depozitul este setat).";
...
$string['turnitinuseerater'] = 'Activați feedbackul gramatical';
$string['turnitinuseerater_desc'] = 'Alegeți dacă doriți ca fișierele depuse să fie verificate din punct de vedere gramatical.<br /><i>(Feedbackul gramatical trebuie, de asemenea, să fie activat în contul Turnitin)</i>';
