...
/**
 * Strings for component 'plagiarism_turnitin', language 'fr'
 *
...
$string['erater'] = 'Activer le retour sur la grammaire';
...
$string['turnitinuseerater'] = 'Activer le retour sur la grammaire';
$string['turnitinuseerater_desc'] = 'Choisissez si les fichiers soumis peuvent faire l’objet d’un contrôle grammatical.<br /><i>(Le retour sur la grammaire doit également être activé sur votre compte Turnitin.)</i>';
