...
$string['turnitinuseanon_desc_old'] = 'Välj om du vill möjliggöra Anonyma kommentarer vid betygsättning av inlämningar.<br /><i>(Detta är endast tillgängligt för dem som har Anonyma Kommentarer konfigurerat för sitt konto)</i>';
