...
$string['reportgenspeed_help'] = "Bu ödev ayarları için üç seçenek vardır: 'Raporları anında oluşturun. Gönderiler, depoya anında eklenecektir (depo ayarlanmışsa).', 'Raporları anında oluşturun. Gönderiler, depoya teslim tarihinde eklenecektir (depo ayarlanmışsa).', ve 'Raporları teslim tarihinde oluşturun. Gönderiler, depoya teslim tarihinde eklenecektir (depo ayarlanmışsa).'<br /><br />'Raporları anında oluşturun. Gönderiler, depoya anında eklenecektir (depo ayarlanmışsa)' seçeneği, bir öğrenci bir gönderi yaptığında anında Özgünlük Raporu oluşturur ve gönderiler bir depoda saklandıysa daha sonraki gönderiler önceki gönderilerle karşılaştırılır.<br /><br />'Raporları anında oluşturun. Gönderiler, depoya teslim tarihinde eklenecektir (depo ayarlanmışsa).' bir öğrenci bir gönderi yaptığında anında bir Özgünlük Raporu oluşturur ve gönderiler bir depoda saklandıysa ödev teslim tarihinde gizli anlaşma kontrolü gerçekleşir.<br /><br />'Raporları teslim tarihinde oluşturun. Gönderiler, depoya teslim tarihinde eklenecektir (depo ayarlanmışsa).' seçeneği, Özgünlük Raporu oluşturur ve gönderiler bir depoda saklandıysa ödev teslim tarihinde bir gizli anlaşma kontrolü gerçekleştirir.";
...
$string['nonsubmittingstudentinfo'] = "Bu grup gönderisine ait Turnitin raporunu veya geri bildirimini görüntülemek için lütfen öğretmeninizle veya grubunuz adına gönderim yapan öğrenciyle iletişime geçin.";

$string['enableadhocsubmissions'] = "Gönderi kuyruğu için geçici görev işlemeyi etkinleştir";
$string['adhoc_sendqueuedsubmission'] = "Geçici görev: Turnitin İntihal Eklentisindeki kuyruğa alınmış bir gönderiyi gönder";
