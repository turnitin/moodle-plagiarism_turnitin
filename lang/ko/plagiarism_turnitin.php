...
$string['ppagreement_default'] = '이 박스에 체크함으로써 본 제출물이 나의 저작임을 확인하며 이의 제출 결과로 발생할 수 있는 모든 저작권 침해에 대해 책임을 받아들입니다.';
$string['ppagreement_desc'] = '<b>[선택]</b><br />제출물에 대한 동의 확인 문장을 입력하십시오.<br />(<b>주의:</b> 본 동의서가 공백일 경우, 제출 도중 학생에 의한 동의 확인이 요구되지 않을 것입니다)';
$string['ppagreement'] = '면책조항/동의';
