...
$string['erater'] = 'Permitir feedback gramatical';
...
$string["reportgen_immediate_add_immediate"] = "Gere relatórios imediatamente. Os relatórios serão adicionados ao repositório imediatamente (se o repositório estiver definido).";
$string["reportgen_immediate_add_duedate"] = "Gere relatórios imediatamente. Os relatórios serão adicionados ao repositório na data prevista (se o repositório estiver definido).";
$string["reportgen_duedate_add_duedate"] = "Gere relatórios na data prevista. Os relatórios serão adicionados ao repositório na data prevista (se o repositório estiver definido).";
...
$string['turnitinuseerater'] = 'Permitir feedback gramatical';
$string['turnitinuseerater_desc'] = 'Escolha se os arquivos enviados podem receber uma verificação gramatical.<br /><i>(O feedback de gramática também deve estar habilitado em sua conta do Turnitin)</i>';
